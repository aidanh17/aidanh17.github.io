...
export const projects: Project[] = [
    ...
    directions: [
      ...
      },
      {
        ...
        fullDescription: [
          ...
          "We addressed this using algebraic quantum field theory, a framework that characterizes quantum theories through the structure of their operator algebras rather than through specific states or correlators. We showed that the Hagedorn density of states, the exponential growth of the string spectrum, causes a breakdown of the split property, a rigorous formulation of the statistical independence of observations in spacelike-separated regions. When two regions are separated by less than the string length, their operator algebras are no longer independent: one cannot prepare arbitrary independent states in the two regions simultaneously. This gives a precise, model-independent definition of the stretched horizon as the locus where the split property fails. We extended this to define stretched quantum extremal surfaces and discussed implications for the black hole information problem.",
        ],
        papers: ["2510.01556"],
      },
      {
        ...
        description:
          "AdS/CFT gives concrete, quantitative predictions for the correlation functions of strongly coupled quantum systems, predictions that can be tested numerically in systems like BFSS. We develop systematic methods for computing these boundary correlators from perturbative gravity in anti-de Sitter space, importing the modern amplitudes toolkit into curved spacetime.",
        fullDescription: [
          "The AdS/CFT correspondence turns the problem of computing correlators in a strongly coupled quantum system into a perturbative gravity calculation on anti-de Sitter space. We evaluate Witten diagrams, the curved-spacetime analogues of Feynman diagrams, in which bulk fields propagate through the AdS geometry and interact at vertices set by the gravitational action. While the first examples were computed decades ago, systematically evaluating higher-point and higher-loop diagrams has remained a major technical bottleneck. These calculations have direct experimental relevance: in the BFSS matrix model, the boundary theory is a quantum-mechanical system amenable to Monte Carlo simulation, so our perturbative gravity predictions for correlators can be tested against numerical experiment, one of the few arenas where holographic predictions meet real data.",
          "We developed several tools to make these calculations systematic. We showed that BCJ amplitude relations, identities among scattering amplitudes discovered in flat-space gauge theory, have direct analogues for AdS boundary correlators in embedding space, reducing the number of independent structures one must compute. We established a differential representation for these correlators and demonstrated that color-kinematics duality, a key organizing principle of the flat-space amplitudes program, extends to the AdS setting. At the loop level, we introduced a framework for higher-loop Witten diagrams and derived difference equations and integral reduction techniques analogous to integration-by-parts identities. The Witten-Feynman parameterization gives a general integral representation valid for all masses at any loop order, overcoming a long-standing restriction to conformally coupled scalars. Together, these results bring the algorithmic methods of modern amplitudes research into curved spacetime.",
        ],
  ...
  },
  {
    ...
    overview:
      "Gravitational wave astronomy has opened a new window onto the universe. To fully exploit observatories like LIGO and future detectors, we need increasingly precise theoretical predictions for the waveforms produced by compact binary systems. This project develops new methods, rooted in the scattering amplitudes program of particle physics, to compute these waveforms systematically and to high precision.",
    directions: [
      {
        slug: "waveforms-from-amplitudes",
        title: "Gravitational waveforms from scattering amplitudes",
        description:
          "We use quantum field theory methods, originally developed for particle collider calculations, to systematically compute the gravitational waveforms produced when two black holes scatter. Working in the post-Minkowskian expansion, we computed the sub-leading scattering waveform for uncharged black holes in general relativity and for half-BPS black holes in N=8 supergravity. This amplitudes-based approach provides an independent route to the high-precision predictions needed for current and next-generation gravitational wave observatories.",
        fullDescription: [
          "Gravitational wave detectors like LIGO work by matching incoming signals against theoretical waveform templates. The more accurate the template, the more we learn about the colliding black holes that produced the wave. Computing these templates from general relativity is notoriously difficult, especially at the precision demanded by next-generation detectors. We bring a different set of tools to the problem: scattering amplitudes, the mathematical objects at the heart of particle physics calculations at the LHC. The idea is to treat gravitating black holes as heavy particles and compute their scattering waveform order-by-order in Newton's constant, an approach known as the post-Minkowskian expansion. This complements the more traditional post-Newtonian approach, which is organized by powers of velocity and is best suited to slowly moving bound orbits.",
          "We computed the sub-leading waveform for the scattering of two black holes in general relativity, as well as for a special class of black holes in N=8 supergravity where additional symmetries provide strong consistency checks. In a separate collaboration with Bini, Damour, and others, we compared our amplitudes-based results against a complementary formalism rooted in gravitational self-force theory, finding precise agreement and providing a cross-validation of both approaches. These calculations feed directly into the waveform models used by LIGO and future observatories like LISA and the Einstein Telescope.",
        ],
      ...
      },
      {
        ...
        description:
          "A basic question in general relativity is whether the gravitational field \"peels off\" in a specific way at large distances from a source, a property called asymptotic simplicity. Using the stress tensor of a two-body system as a source, we computed the spacetime metric at finite observer distance and investigated the fall-off behavior of the Newman-Penrose scalars. We found that the Sachs peeling property is violated, and that at higher orders in the post-Minkowskian expansion the breakdown is significantly stronger than previously recognized.",
        fullDescription: [
          ...
          "We addressed this using the post-Minkowskian expansion, computing the spacetime metric produced by a two-body gravitational encounter at finite observer distance. We found that peeling is violated: the gravitational field does not fall off in the expected hierarchy. At higher orders in the expansion the violations grow worse, with logarithmic and poly-logarithmic corrections that had not been previously identified. This matters beyond mathematical aesthetics. The definitions of gravitational-wave energy, angular momentum, and memory effects at large distances all rely on assumptions about asymptotic fall-off, and our results show those assumptions need to be revisited.",
        ],
        papers: ["2511.10637"],
      },
    ],
    ...
    directions: [
      {
        ...
        description:
          "Scalar fields in theories of gravity inhabit a moduli space of vacua, and their spatial or temporal variations produce measurable gravitational effects, from driving inflation to shifting black hole horizons. We derived a sharp, quantitative bound on how much a scalar field can change along null geodesics (the paths of light rays), using the Raychaudhuri equation under the assumption that other fields satisfy the null energy condition. The bound is saturated in certain spacetimes with timelike naked singularities, giving it a clean geometric interpretation. A possible extension to semiclassical spacetimes using a strengthened quantum focusing condition is also explored.",
        fullDescription: [
          "Scalar fields appear throughout gravitational physics. They drive the expansion of the early universe during inflation, parametrize different vacua in string theory, and their variations near black holes produce observable gravitational effects. A basic question is: how far can a scalar field move in its field space while the gravitational description remains under control? The swampland program in string theory suggests there are fundamental limits, but most existing bounds are qualitative. We derived a precise, quantitative upper bound on the total field excursion along any null geodesic, the path followed by a light ray, using the Raychaudhuri equation and the assumption that the remaining matter satisfies the null energy condition.",
          "The bound has a clean geometric form. It is sharp: it is exactly saturated in certain spacetimes with naked singularities, confirming that it cannot be improved without additional assumptions. We applied it to inflationary cosmology, where the inflaton must roll across its potential for many e-folds, and to the near-horizon geometry of extremal black holes. We also explored a semiclassical extension based on a strengthened quantum focusing condition, which would extend the bound into regimes where quantum corrections to gravity become important. The result connects formal energy-condition arguments to the observational constraints that upcoming CMB and large-scale structure experiments will impose on inflationary models.",
        ],
        papers: ["2510.01554"],
      },
      {
  ...
  },
  {
    ...
    overview:
      "The other projects on this site use string theory and its low-energy limits as tools for making predictions about gravitational waveforms, inflationary correlators, and holographic quantum systems. But why should string theory be the right framework? The bootstrap program provides the justification: starting from minimal physical assumptions (unitarity, Lorentz invariance, analyticity) and asking what scattering amplitudes are allowed, a growing body of evidence shows that the unique answer at high energies is the Veneziano amplitude, the hallmark of string theory. If string theory is the only consistent UV completion of gravity, then any laboratory system dual to gravity, from BFSS to future quantum simulators of holographic matter, must exhibit stringy signatures, turning a formal uniqueness result into a concrete experimental prediction. This work was recently featured in a Quanta Magazine article, [\"Are Strings Still Our Best Hope for a Theory of Everything?\"](https://www.quantamagazine.org/are-strings-still-our-best-hope-for-a-theory-of-everything-20260323/).",
    directions: [
      {
        ...
        fullDescription: [
          "Is string theory the only consistent theory of quantum gravity, or just one possibility among many? The bootstrap approach tackles this question from the bottom up. We start with the most general scattering amplitude consistent with basic physical principles: unitarity (probabilities sum to one), crossing symmetry (the same amplitude describes different scattering channels), and analyticity (the amplitude is a well-behaved function of energy and angle). We then systematically narrow down what theories are allowed. If the only amplitudes that satisfy all the constraints turn out to be stringy, this is strong evidence that any consistent quantum theory of gravity must reduce to string theory at short distances.",
          "We have made progress from several complementary directions. We showed that string monodromy relations, identities among amplitudes long thought to be specific to string theory, in fact emerge from the low-energy structure of any consistent UV completion, suggesting that stringy structure is forced upon any theory of quantum gravity. We bootstrapped the KLT kernel connecting open- and closed-string amplitudes and found it to be highly constrained. We studied the space of allowed effective field theory coefficients, the \"EFT-hedron,\" and showed that supersymmetric positivity bounds dramatically shrink this space, pushing it toward the unique string theory point. Most recently, we proved that for a theory with maximal supersymmetry and two additional technical assumptions, the Veneziano amplitude is the unique UV completion, the first result establishing, in a precise sense, that the only consistent high-energy behavior is stringy.",
        ],
        papers: ["2601.11705", "2212.13998", "2302.04895", "2310.10729", "2106.12600"],
      },
    ],
    tags: [
      "String Theory",
